...
func TestStoreCreateValidate(t *testing.T) {
	...
	token, sess, err := s.Create("dev", "agent1", nil, []string{"dev/*"}, nil, "bearer", "", "127.0.0.1", false, 0)
	if err != nil {
...
func TestStoreCreateWithSealKey(t *testing.T) {
	...
	_, sess, err := s.Create("secure", "agent1", sealKey, []string{"prod/*"}, nil, "mtls", "", "192.168.0.10", false, 0)
	if err != nil {
		t.Fatalf("Create: %v", err)
	}
...
func TestStoreExpiredSession(t *testing.T) {
	...
	token, _, err := s.Create("dev", "agent1", nil, []string{"dev/*"}, nil, "bearer", "", "127.0.0.1", false, 1*time.Millisecond)
	if err != nil {
		t.Fatalf("Create: %v", err)
	}
...
func TestStoreGet(t *testing.T) {
	...
	_, sess, err := s.Create("dev", "agent1", nil, []string{"dev/*"}, nil, "bearer", "", "127.0.0.1", false, 0)
	if err != nil {
		t.Fatalf("Create: %v", err)
	}
...
func TestStoreList(t *testing.T) {
	...
	for i := 0; i < 3; i++ {
		_, _, err := s.Create("dev", "agent1", nil, []string{"dev/*"}, nil, "bearer", "", "127.0.0.1", false, 0)
		if err != nil {
...
func TestStoreListExcludesRevoked(t *testing.T) {
	...
	_, sess1, _ := s.Create("dev", "agent1", nil, []string{"dev/*"}, nil, "bearer", "", "127.0.0.1", false, 0)
	s.Create("dev", "agent2", nil, []string{"dev/*"}, nil, "bearer", "", "127.0.0.1", false, 0)
...
func TestStoreConcurrentAccess(t *testing.T) {
	...
	for i := 0; i < 50; i++ {
		...
		go func() {
			defer wg.Done()
			token, _, err := s.Create("dev", "agent", nil, []string{"dev/*"}, nil, "bearer", "", "127.0.0.1", false, 0)
			if err != nil {
...
func TestStoreCleanup(t *testing.T) {
	...
	_, _, err = s.Create("dev", "agent2", nil, []string{"dev/*"}, nil, "bearer", "", "127.0.0.1", false, 0)
	if err != nil {
		t.Fatalf("Create: %v", err)
	}
...
func TestStoreExplicitActions(t *testing.T) {
	...
	_, sess, err := s.Create("deployer", "agent1", nil, []string{"deploy/*"}, []string{"list", "read_value", "write"}, "bearer", "", "127.0.0.1", false, 0)
	if err != nil {
		t.Fatalf("Create: %v", err)
	}
...
func TestStoreAdminAction(t *testing.T) {
	...
	_, sess, err := s.Create("admin", "agent1", nil, []string{"*"}, []string{"admin"}, "bearer", "", "127.0.0.1", false, 0)
	if err != nil {
		t.Fatalf("Create: %v", err)
	}
...
func TestStoreRenewExpired(t *testing.T) {
	...
	_, sess, err := s.Create("dev", "agent1", nil, []string{"dev/*"}, nil, "bearer", "", "127.0.0.1", false, time.Millisecond)
	if err != nil {
		t.Fatalf("Create: %v", err)
	}
...
func TestParseClaimsInsecure(t *testing.T) {
	...
	token, sess, err := store.Create("dev", "test-agent", nil, []string{"test/*"}, nil, "bearer", "", "127.0.0.1", false, 1*time.Second)
	if err != nil {
		t.Fatalf("create: %v", err)
	}
